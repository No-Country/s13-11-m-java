...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new org.springframework.security.core.userdetails.User(optionalUser.get().getCommonAttribute().getEmail(), optionalUser.get().getCommonAttribute().getPassword()
        ,new ArrayList<>());
    }
