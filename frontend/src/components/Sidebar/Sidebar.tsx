        ...
        <ul className="flex max-md:space-x-1 md:flex-col">
          {menuItems.map((item, index) => (
            <li
              ...
              className="relative before:absolute before:w-[3px] before:rounded-sm hover:before:bg-primary/50 data-[active=true]:bg-accent before:data-[active=true]:bg-primary max-md:before:bottom-0 max-md:before:h-0.5 max-md:before:w-full md:before:left-0 md:before:h-full"
            >
